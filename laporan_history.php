...
$pdf->Cell(35,6,'Cek Out',1,0);
$pdf->Cell(21,6,'Lama Sewa',1,0);
$pdf->Cell(25,6,'Telat',1,0);
$pdf->Cell(35,6,'Tanggal Booking',1,0);
$pdf->Cell(25,6,'Biaya Sewa',1,0);
$pdf->Cell(25,6,'Biaya Denda',1,1);
...
$query = mysqli_query($conn, "SELECT * FROM transaksi t
			...
			(cek_out < CURRENT_TIMESTAMP) AND t.id_konsumen ='$id_konsumen'");
while ($row = mysqli_fetch_array($query)){
    ...
    $pdf->Cell(35,6,$row['cek_out'],1,0);
    $pdf->Cell(21,6,$row['lama_pakai'],1,0);
    $pdf->Cell(25,6,$row['keterlambatan'],1,0);
    $pdf->Cell(35,6,$row['tanggal_transaksi'],1,0);
    $pdf->Cell(25,6,'Rp.'.number_format($row['total_biaya']),1,0);
    $pdf->Cell(25,6,'Rp.'.number_format($row['biaya_denda']),1,1);
}

    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="card-body">
          ...
          $cek_password = $koneksi->query("SELECT * FROM konsumen WHERE id_konsumen ='$id_konsumen'");
          $cekp = $cek_password->fetch_assoc();
          $user_password = $cekp['password_konsumen'];
          if(password_verify($plama,$user_password)){
            $submit = $koneksi->query("UPDATE konsumen SET password_konsumen='$encryptpbaru' WHERE id_konsumen='$id_konsumen'");
